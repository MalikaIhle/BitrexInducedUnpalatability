...
AllAttacks <- read.csv(file="AllAttacks1_5.csv", header=TRUE, sep=",")
FocalTermiteAttack <- read.csv(file = "FocalTermiteAttack1_5.csv", header=TRUE, sep=",")
FirstAttacks <- read.csv(file = "FirstAttacks1_5.csv", header=TRUE, sep=",")
